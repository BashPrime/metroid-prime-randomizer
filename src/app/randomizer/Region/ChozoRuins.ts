...
export class ChozoRuins extends Region {
    constructor() {
        ...
        this.locations = new Map<string, Location>([
            ...
            ["Main Plaza (Locked Door)", new Location("Main Plaza (Locked Door)", "d5cdb809.mrea", 0x00020156)],
            ["Ruined Fountain", new Location("Ruined Fountain", "165a4de9.mrea", 0x00080076)],
            ["Ruined Shrine (Beetle Battle)", new Location("Ruined Shrine (Beetle Battle)", "3c785450.mrea", 0x00090024)],
            ...
            ["Training Chamber", new Location("Training Chamber", "3f04f304.mrea", 0x000C0026)],
            ...
            ["Tower of Light", new Location("Tower of Light", "0d72f1f7.mrea", 0x00150335)],
            ["Tower Chamber", new Location("Tower Chamber", "11bd63b7.mrea", 0x001B0019)],
            ...
            ["Transport Access North", new Location("Transport Access North", "3ad2120f.mrea", 0x001E0172)],
            ["Gathering Hall", new Location("Gathering Hall", "47e73bc5.mrea", 0x00200057)],
            ["Hive Totem", new Location("Hive Totem", "c8309df6.mrea", 0x002401DC)],
            ["Sunchamber (Flaahgra)", new Location("Sunchamber (Flaahgra)", "9a0a03eb.mrea", 0x002528EE)],
            ["Sunchamber (Ghosts)", new Location("Sunchamber (Ghosts)", "9a0a03eb.mrea", 0x18252F7D)],
            ["Watery Hall Access", new Location("Watery Hall Access", "eeec837d.mrea", 0x00260008)],
            ["Watery Hall (Scan Puzzle)", new Location("Watery Hall (Scan Puzzle)", "492cbf4a.mrea", 0x00290085)],
            ...
            ["Burn Dome (I. Drone)", new Location("Burn Dome (I. Drone)", "4148f7b0.mrea", 0x0030278A)],
            ["Furnace (Spider Tracks)", new Location("Furnace (Spider Tracks)", "2e318473.mrea", 0x0031005E)],
            ["Furnace (Tunnel)", new Location("Furnace (Tunnel)", "2e318473.mrea", 0x0031000A)],
            ["Hall of the Elders", new Location("Hall of the Elders", "fb54a0cb.mrea", 0x003402DE)],
            ["Crossway", new Location("Crossway", "13fff119.mrea", 0x003502C8)],
            ["Elder Chamber", new Location("Elder Chamber", "e1981efc.mrea", 0x00390003)],
            ["Antechamber", new Location("Antechamber", "afefe677.mrea", 0x003D0003)]
        ]);
    }
