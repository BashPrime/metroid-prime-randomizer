...
export class PhazonMines extends Region {
    constructor() {
        ...
        this.locations = new Map<string, Location>([
            ...
            ["Storage Depot B", new Location("Storage Depot B", "e39c342b.mrea", 0x00090003)],
            ...
            ["Ventilation Shaft", new Location("Ventilation Shaft", "90709aac.mrea", 0x0012010C)],
            ["Central Dynamo", new Location("Central Dynamo", "fea372e2.mrea", 0x001B04B1)],
        ]);
    }
