...
export class UpdateService {
  ...
  checkForUpdates(): void {
    this.http.get('https://raw.githubusercontent.com/etaylor8086/metroid-prime-randomizer/master/package.json')
      .subscribe((data: any) => {
        if (compareVersions(version, data.version) < 0) {
          ...
          }).onTap.pipe(take(1)).subscribe(() => this.electronService.shell.openExternal('https://github.com/etaylor8086/metroid-prime-randomizer/releases/latest'))
        }
      });
  }
}
